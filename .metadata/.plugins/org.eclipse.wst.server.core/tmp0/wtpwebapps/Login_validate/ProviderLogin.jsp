		...
		<div class="container-login100"
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<div class="login100-form validate-form">
					<span class="login100-form-title p-b-49"> Provider Login </span>
					...
					<div class="wrap-input100 validate-input m-b-23"
						...
						<div id="passInputWrapper">
							<h:inputSecret id="passInput" value="#{provider.password}" />
						</div>
					</div>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<h:commandButton action="#{providerDao.login(provider)}"
								value="Login"
								style="height: 35px;
                                        outline: none;
                                        border: none;
						...
						<h:outputText value="#{passWordErr2}" style="color: red;" />
					</div>
					<div class="text-right p-t-8 p-b-31">
